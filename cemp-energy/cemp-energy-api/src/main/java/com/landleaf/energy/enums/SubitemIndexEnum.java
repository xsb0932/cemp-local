...
public enum SubitemIndexEnum {
     ...
     */
    CARBON_USAGE_COAL_TOTAL("projectCarbonTotalcoalTotal", ""),
    /**
     * 二氧化碳减少量
    ...
    /**
     * 空调单方用电量
     * project_electricity_subhavcenergy_avgsq
     */
    PROJECT_ELECTRICITY_SUBHAVCENERGY_AVGSQ("projectElectricitySubhavcenergyAvgsq", ""),

    /**
     * 热水单立方用电量
     * project_electricity_subHeatingWaterEnergy_avgCube
     */
    PROJECT_ELECTRICITY_SUBHEATINGWATERENERGY_AVGCUBE("projectElectricitySubheatingwaterenergyAvgcube", ""),

    /**
     * 空调补水
     * project_water_HVACUsage_total
     */
    PROJECT_WATER_HVACUSAGE_TOTAL("projectWaterHvacusageTotal", "projectWaterHvacusageTotal"),

    /**
     * 热水补水
     * project_water_heatingwaterusage_total
     */
    PROJECT_WATER_HEATINGWATERUSAGE_TOTAL("projectWaterHeatingwaterusageTotal", "projectWaterHeatingwaterusageTotal"),

    /**
     * 平均温度
     * project_environment_outtemp_avg
     */
    PROJECT_ENVIRONMENT_OUTTEMP_AVG("projectEnvironmentOutTempAvg", "projectEnvironmentOutTempAvg");
