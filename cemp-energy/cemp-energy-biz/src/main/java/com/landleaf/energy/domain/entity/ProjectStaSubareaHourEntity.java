...
@Schema(name = "ProjectStaSubareaHourEntity对象", description = "ProjectStaSubareaHourEntity对象")
@TableName("tb_project_sta_subarea_hour")
public class ProjectStaSubareaHourEntity extends BaseEntity {
