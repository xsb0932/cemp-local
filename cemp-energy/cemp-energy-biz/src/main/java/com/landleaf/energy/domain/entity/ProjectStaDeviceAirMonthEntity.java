...
@Schema(name = "ProjectStaDeviceAirMonthEntity对象", description = "统计表-设备指标-空调-统计月")
@TableName("tb_project_sta_device_air_month")
public class ProjectStaDeviceAirMonthEntity extends BaseEntity {
