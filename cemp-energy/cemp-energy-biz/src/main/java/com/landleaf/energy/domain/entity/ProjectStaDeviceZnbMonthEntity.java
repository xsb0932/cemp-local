...
@Schema(name = "ProjectStaDeviceZnbMonthEntity", description = "统计表-设备指标-组串逆变器-统计月")
@TableName("tb_project_sta_device_znb_month")
public class ProjectStaDeviceZnbMonthEntity extends BaseEntity {
