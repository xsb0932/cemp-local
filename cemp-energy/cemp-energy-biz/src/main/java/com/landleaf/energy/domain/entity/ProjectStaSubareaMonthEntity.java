...
@Schema(name = "ProjectStaSubareaMonthEntity对象", description = "ProjectStaSubareaMonthEntity对象")
@TableName("tb_project_sta_subarea_month")
public class ProjectStaSubareaMonthEntity extends BaseEntity {
