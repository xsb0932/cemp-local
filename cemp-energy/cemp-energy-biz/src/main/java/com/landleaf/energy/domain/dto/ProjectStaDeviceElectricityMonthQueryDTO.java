...
@Schema(name = "ProjectStaDeviceElectricityMonthQueryDTO对象", description = "统计表-设备指标-电表-统计月的查询时的参数封装")
public class ProjectStaDeviceElectricityMonthQueryDTO extends PageParam {
