...
@Schema(name = "ProjectStaDeviceAirYearQueryDTO对象", description = "统计表-设备指标-空调-统计年的查询时的参数封装")
public class ProjectStaDeviceAirYearQueryDTO extends PageParam {
