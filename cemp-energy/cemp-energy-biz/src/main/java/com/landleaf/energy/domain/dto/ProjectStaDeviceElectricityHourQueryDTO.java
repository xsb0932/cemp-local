...
@Schema(name = "ProjectStaDeviceElectricityHourQueryDTO对象", description = "统计表-设备指标-电表-统计小时的查询时的参数封装")
public class ProjectStaDeviceElectricityHourQueryDTO extends PageParam {
