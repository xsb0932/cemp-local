...
/**
 * 统计表-设备指标-气类-统计月的数据库操作句柄
 *
 * @author hebin
 * @since 2023-06-24
 */
@Mapper
public interface ProjectStaDeviceGasMonthMapper extends ExtensionMapper<ProjectStaDeviceGasMonthEntity> {
    /**
    ...
    ProjectStaDeviceGasMonthEntity getManualInsertData(@Param("bizDeviceId") String bizDeviceId);
}
