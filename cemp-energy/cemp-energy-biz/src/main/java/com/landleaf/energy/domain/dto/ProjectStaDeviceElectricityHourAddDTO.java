...
/**
 * 统计表-设备指标-电表-统计小时的新增时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaDeviceElectricityHourAddDTO对象", description = "统计表-设备指标-电表-统计小时的新增时的参数封装")
public class ProjectStaDeviceElectricityHourAddDTO {
