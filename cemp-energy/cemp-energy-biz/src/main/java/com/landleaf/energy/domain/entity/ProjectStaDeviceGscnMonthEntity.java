...
@Schema(name = "ProjectStaDeviceGscnMonthEntity", description = "统计表-设备指标-储能系统-统计月")
@TableName("tb_project_sta_device_gscn_month")
public class ProjectStaDeviceGscnMonthEntity extends BaseEntity {
