...
@Schema(name = "ProjectStaDeviceGasMonthQueryDTO对象", description = "统计表-设备指标-气类-统计月的查询时的参数封装")
public class ProjectStaDeviceGasMonthQueryDTO extends PageParam {
