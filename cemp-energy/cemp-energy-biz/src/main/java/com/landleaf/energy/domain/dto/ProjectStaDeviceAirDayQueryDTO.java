...
@Schema(name = "ProjectStaDeviceAirDayQueryDTO对象", description = "统计表-设备指标-空调-统计天的查询时的参数封装")
public class ProjectStaDeviceAirDayQueryDTO extends PageParam {
