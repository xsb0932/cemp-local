...
/**
 * ProjectStaSubitemDayEntity对象的展示信息封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaSubitemDayVO对象", description = "ProjectStaSubitemDayEntity对象的展示信息封装")
public class ProjectStaSubitemDayVO {
