...
@Schema(name = "ProjectStaDeviceGasMonthEntity对象", description = "统计表-设备指标-气类-统计月")
@TableName("tb_project_sta_device_gas_month")
public class ProjectStaDeviceGasMonthEntity extends BaseEntity {
     ...
     * 用气量期初值
     */
    @Schema(description = "用气量期初值")
    private BigDecimal gasmeterUsageTotalStart;

    /**
     * 用气量期末值
     */
    @Schema(description = "用气量期末值")
    private BigDecimal gasmeterUsageTotalEnd;
