...
/**
 * 统计表-设备指标-电表-统计年的展示信息封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaDeviceElectricityYearVO对象", description = "统计表-设备指标-电表-统计年的展示信息封装")
public class ProjectStaDeviceElectricityYearVO {
