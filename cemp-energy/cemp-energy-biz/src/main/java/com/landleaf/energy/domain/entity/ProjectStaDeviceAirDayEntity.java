...
@Schema(name = "ProjectStaDeviceAirDayEntity对象", description = "统计表-设备指标-空调-统计天")
@TableName("tb_project_sta_device_air_day")
public class ProjectStaDeviceAirDayEntity extends BaseEntity {
