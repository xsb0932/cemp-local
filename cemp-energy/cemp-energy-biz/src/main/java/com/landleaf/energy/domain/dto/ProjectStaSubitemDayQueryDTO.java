...
/**
 * ProjectStaSubitemDayEntity对象的查询时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
...
@Schema(name = "ProjectStaSubitemDayQueryDTO对象", description = "ProjectStaSubitemDayEntity对象的查询时的参数封装")
public class ProjectStaSubitemDayQueryDTO extends PageParam {
