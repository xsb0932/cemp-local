...
@Schema(name = "ProjectStaDeviceGasHourEntity对象", description = "统计表-设备指标-气类-统计小时")
@TableName("tb_project_sta_device_gas_hour")
public class ProjectStaDeviceGasHourEntity extends BaseEntity {
