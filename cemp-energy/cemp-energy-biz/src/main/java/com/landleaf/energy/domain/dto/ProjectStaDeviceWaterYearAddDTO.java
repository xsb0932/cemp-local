...
/**
 * 统计表-设备指标-水表-统计年的新增时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaDeviceWaterYearAddDTO对象", description = "统计表-设备指标-水表-统计年的新增时的参数封装")
public class ProjectStaDeviceWaterYearAddDTO {
