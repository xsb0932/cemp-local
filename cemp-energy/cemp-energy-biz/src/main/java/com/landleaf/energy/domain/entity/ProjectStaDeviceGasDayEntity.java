...
@Schema(name = "ProjectStaDeviceGasDayEntity对象", description = "统计表-设备指标-气类-统计天")
@TableName("tb_project_sta_device_gas_day")
public class ProjectStaDeviceGasDayEntity extends BaseEntity {
