...
@Schema(name = "ProjectStaDeviceGasHourQueryDTO对象", description = "统计表-设备指标-气类-统计小时的查询时的参数封装")
public class ProjectStaDeviceGasHourQueryDTO extends PageParam {
