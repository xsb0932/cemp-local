...
@Schema(name = "ProjectStaSubareaYearEntity对象", description = "ProjectStaSubareaYearEntity对象")
@TableName("tb_project_sta_subarea_year")
public class ProjectStaSubareaYearEntity extends BaseEntity {
