...
@Schema(name = "ProjectStaDeviceGscnHourEntity", description = "统计表-设备指标-储能系统-统计小时")
@TableName("tb_project_sta_device_gscn_hour")
public class ProjectStaDeviceGscnHourEntity extends BaseEntity {
