...
@Schema(name = "ProjectStaDeviceGasYearQueryDTO对象", description = "统计表-设备指标-气类-统计年的查询时的参数封装")
public class ProjectStaDeviceGasYearQueryDTO extends PageParam {
