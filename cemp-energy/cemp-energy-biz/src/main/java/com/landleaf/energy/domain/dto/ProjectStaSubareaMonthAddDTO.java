...
/**
 * ProjectStaSubareaMonthEntity对象的新增时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaSubareaMonthAddDTO对象", description = "ProjectStaSubareaMonthEntity对象的新增时的参数封装")
public class ProjectStaSubareaMonthAddDTO {
