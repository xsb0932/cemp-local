...
import static com.landleaf.comm.exception.enums.GlobalErrorCodeConstants.UNAUTHORIZED;
...
public class AuthenticationEntryPointImpl implements ServerAuthenticationEntryPoint {
    ...
    public Mono<Void> commence(ServerWebExchange exchange, AuthenticationException ex) {
        ...
        DataBuffer dataBuffer = response.bufferFactory().wrap(JSON.toJSONBytes(Response.error(UNAUTHORIZED)));
