...
@Data
@Schema(description = "光字牌-热水回路VO")
public class LightBoardCircuitHotWaterResponse {
    ...
    @Schema(description = "供水温度")
    private String supplyWaterTemp;
    @Schema(description = "供水温度单位")
