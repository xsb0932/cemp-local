 ...
 **/
@Data
@Schema(name = "新增管理节点请求参数", description = "新增管理节点请求参数")
public class ManagementNodeAddRequest {
    /**
     * 节点名称
     */
    ...
    @Schema(description = "父节点业务id", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
