 ...
 */
@Data
@Schema(name = "DeviceMonitorRequest对象", description = "设备-监测平台的新增时的参数封装")
public class DeviceIotRequest extends PageParam  {
    ...
    private List<DeviceParameterDetailRequest> deviceParameters;
