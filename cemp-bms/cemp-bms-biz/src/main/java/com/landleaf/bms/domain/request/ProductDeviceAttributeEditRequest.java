 ...
 **/
@Data
@Schema(name = "产品-编辑设备属性请求参数", description = "产品-编辑设备属性请求参数")
public class ProductDeviceAttributeEditRequest extends ValueDescriptionParam {
    /**
     * 设备属性id
     */
    @NotNull(message = "设备属性id不能为空")
    @Schema(description = "设备属性id不能为空", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    private Long id;
    ...
    public void mergeEntity(ProductDeviceAttributeEntity entity) {
        validate();
