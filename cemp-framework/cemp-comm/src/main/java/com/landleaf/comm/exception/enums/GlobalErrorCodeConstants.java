package com.landleaf.comm.exception.enums;
...
public interface GlobalErrorCodeConstants {
    ...
    // =============== license ================
    ErrorCode USER_LIMIT = new ErrorCode("8000001", "用户数量超出平台授权数量，创建失败！");
    ErrorCode DEVICE_LIMIT = new ErrorCode("8000002", "设备数量超出平台授权数量，创建失败！");
    ErrorCode PROJ_LIMIT = new ErrorCode("8000003", "项目数量超出平台授权数量，创建失败！");
    ErrorCode LICENSE_LIMIT = new ErrorCode("8000010", "系统授权过期，请联系管理员！");
}
