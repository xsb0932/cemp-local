...
import com.landleaf.gw.domain.WaterMeter;
...
@Component
@Slf4j
@MqttMessageListener(topic = "/jj/PC0003/#")
public class WaterMeterListener extends BaseListener implements MqttListener<String> {
    ...
    public void onMessage(String topic, String msgStr) {
        ...
        WaterMeter msg = JSONUtil.toBean(msgStr, WaterMeter.class);
