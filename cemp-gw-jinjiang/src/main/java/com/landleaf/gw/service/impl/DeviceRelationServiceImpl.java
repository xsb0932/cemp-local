...
public class DeviceRelationServiceImpl implements DeviceRelationService {
    ...
    static {
        ...
        gaugesIdRelationMap.put("SHLL31013F02", "D000000000046");
        gaugesIdRelationMap.put("SHLL31013F01", "D000000000047");
        ...
        idRelationMap.put(JjConstance.GAUGES_SUPPLIER_ID, gaugesIdRelationMap);
        idRelationMap.put(JjConstance.AIR_CONDITION_SUPPLIER_ID, airConditionIdRelationMap);
