...
import com.landleaf.jjgj.domain.entity.ProjectStaDeviceGasYearEntity;
...
/**
 * 统计表-设备指标-气类-统计年的数据库操作句柄
 *
 * @author hebin
 * @since 2023-06-24
 */
@Mapper
public interface ProjectStaDeviceGasYearMapper extends ExtensionMapper<ProjectStaDeviceGasYearEntity> {
    /**
