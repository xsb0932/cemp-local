...
import com.landleaf.jjgj.domain.entity.ProjectStaDeviceAirMonthEntity;
...
/**
 * 统计表-设备指标-空调-统计月的数据库操作句柄
 *
 * @author hebin
 * @since 2023-06-24
 */
@Mapper
public interface ProjectStaDeviceAirMonthMapper extends ExtensionMapper<ProjectStaDeviceAirMonthEntity> {
    /**
