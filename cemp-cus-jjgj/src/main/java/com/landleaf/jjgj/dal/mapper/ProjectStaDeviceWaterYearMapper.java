...
import com.landleaf.jjgj.domain.entity.ProjectStaDeviceWaterYearEntity;
...
/**
 * 统计表-设备指标-水表-统计年的数据库操作句柄
 *
 * @author hebin
 * @since 2023-06-24
 */
@Mapper
public interface ProjectStaDeviceWaterYearMapper extends ExtensionMapper<ProjectStaDeviceWaterYearEntity> {
    /**
