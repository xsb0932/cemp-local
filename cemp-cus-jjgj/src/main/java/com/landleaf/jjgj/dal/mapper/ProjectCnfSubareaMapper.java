...
import com.landleaf.jjgj.domain.entity.ProjectCnfSubareaEntity;
...
public interface ProjectCnfSubareaMapper extends BaseMapper<ProjectCnfSubareaEntity> {
    ...
    @Select("SELECT * FROM tb_project_cnf_subarea t1 where deleted = 0 and t1.kpi_subtype is not null and t1.project_id = #{bizProjectId} order by kpi_type,path")
