...
import com.landleaf.jjgj.domain.entity.ProjectStaDeviceWaterHourEntity;
...
/**
 * 统计表-设备指标-水表-统计小时的数据库操作句柄
 *
 * @author hebin
 * @since 2023-06-24
 */
@Mapper
public interface ProjectStaDeviceWaterHourMapper extends ExtensionMapper<ProjectStaDeviceWaterHourEntity> {
    /**
