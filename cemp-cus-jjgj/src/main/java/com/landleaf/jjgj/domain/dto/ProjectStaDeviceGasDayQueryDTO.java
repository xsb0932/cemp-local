...
@Schema(name = "ProjectStaDeviceGasDayQueryDTO对象", description = "统计表-设备指标-气类-统计天的查询时的参数封装")
public class ProjectStaDeviceGasDayQueryDTO extends PageParam {
