...
/**
 * ProjectStaSubitemMonthEntity对象的新增时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaSubitemMonthAddDTO对象", description = "ProjectStaSubitemMonthEntity对象的新增时的参数封装")
public class ProjectStaSubitemMonthAddDTO {
