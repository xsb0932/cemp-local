...
/**
 * 统计表-设备指标-水表-统计月的新增时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaDeviceWaterMonthAddDTO对象", description = "统计表-设备指标-水表-统计月的新增时的参数封装")
public class ProjectStaDeviceWaterMonthAddDTO {
