...
@Schema(name = "ProjectStaDeviceWaterHourEntity对象", description = "统计表-设备指标-水表-统计小时")
@TableName("tb_project_sta_device_water_hour")
public class ProjectStaDeviceWaterHourEntity extends BaseEntity {
