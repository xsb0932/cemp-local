...
@Schema(name = "ProjectStaDeviceWaterMonthQueryDTO对象", description = "统计表-设备指标-水表-统计月的查询时的参数封装")
public class ProjectStaDeviceWaterMonthQueryDTO extends PageParam {
