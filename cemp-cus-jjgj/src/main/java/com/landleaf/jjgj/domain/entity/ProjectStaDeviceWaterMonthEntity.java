...
@Schema(name = "ProjectStaDeviceWaterMonthEntity对象", description = "统计表-设备指标-水表-统计月")
@TableName("tb_project_sta_device_water_month")
public class ProjectStaDeviceWaterMonthEntity extends BaseEntity {
