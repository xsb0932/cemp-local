...
@Schema(name = "ProjectStaDeviceZnbHourEntity", description = "统计表-设备指标-组串逆变器-统计小时")
@TableName("tb_project_sta_device_znb_hour")
public class ProjectStaDeviceZnbHourEntity extends BaseEntity {
