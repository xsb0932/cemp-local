...
@Schema(name = "ProjectStaSubitemMonthEntity对象", description = "ProjectStaSubitemMonthEntity对象")
@TableName("tb_project_sta_subitem_month")
public class ProjectStaSubitemMonthEntity extends BaseEntity {
