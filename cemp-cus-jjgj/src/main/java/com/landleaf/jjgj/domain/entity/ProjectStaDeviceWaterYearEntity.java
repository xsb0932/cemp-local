...
@Schema(name = "ProjectStaDeviceWaterYearEntity对象", description = "统计表-设备指标-水表-统计年")
@TableName("tb_project_sta_device_water_year")
public class ProjectStaDeviceWaterYearEntity extends BaseEntity {
