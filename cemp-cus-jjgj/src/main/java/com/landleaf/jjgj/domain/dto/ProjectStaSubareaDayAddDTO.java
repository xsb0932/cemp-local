...
/**
 * ProjectStaSubareaDayEntity对象的新增时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaSubareaDayAddDTO对象", description = "ProjectStaSubareaDayEntity对象的新增时的参数封装")
public class ProjectStaSubareaDayAddDTO {
