...
/**
 * ProjectStaSubitemMonthEntity对象的查询时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
...
@Schema(name = "ProjectStaSubitemMonthQueryDTO对象", description = "ProjectStaSubitemMonthEntity对象的查询时的参数封装")
public class ProjectStaSubitemMonthQueryDTO extends PageParam {
