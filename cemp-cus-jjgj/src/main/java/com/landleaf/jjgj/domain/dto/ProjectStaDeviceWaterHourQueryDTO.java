...
@Schema(name = "ProjectStaDeviceWaterHourQueryDTO对象", description = "统计表-设备指标-水表-统计小时的查询时的参数封装")
public class ProjectStaDeviceWaterHourQueryDTO extends PageParam {
