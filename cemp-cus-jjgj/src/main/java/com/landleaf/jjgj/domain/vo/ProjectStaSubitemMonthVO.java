...
/**
 * ProjectStaSubitemMonthEntity对象的展示信息封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaSubitemMonthVO对象", description = "ProjectStaSubitemMonthEntity对象的展示信息封装")
public class ProjectStaSubitemMonthVO {
