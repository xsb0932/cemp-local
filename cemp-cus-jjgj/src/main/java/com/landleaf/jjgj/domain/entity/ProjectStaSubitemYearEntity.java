...
@Schema(name = "ProjectStaSubitemYearEntity对象", description = "ProjectStaSubitemYearEntity对象")
@TableName("tb_project_sta_subitem_year")
public class ProjectStaSubitemYearEntity extends BaseEntity {
