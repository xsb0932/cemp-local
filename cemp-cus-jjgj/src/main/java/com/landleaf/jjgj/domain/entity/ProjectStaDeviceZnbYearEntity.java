...
@Schema(name = "ProjectStaDeviceZnbYearEntity", description = "统计表-设备指标-组串逆变器-统计年")
@TableName("tb_project_sta_device_znb_year")
public class ProjectStaDeviceZnbYearEntity extends BaseEntity {
