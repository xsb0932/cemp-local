...
@Schema(name = "ProjectStaDeviceAirHourEntity对象", description = "统计表-设备指标-空调-统计小时")
@TableName("tb_project_sta_device_air_hour")
public class ProjectStaDeviceAirHourEntity extends BaseEntity {
