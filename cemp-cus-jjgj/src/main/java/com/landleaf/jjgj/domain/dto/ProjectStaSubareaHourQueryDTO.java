...
/**
 * ProjectStaSubareaHourEntity对象的查询时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
...
@Schema(name = "ProjectStaSubareaHourQueryDTO对象", description = "ProjectStaSubareaHourEntity对象的查询时的参数封装")
public class ProjectStaSubareaHourQueryDTO extends PageParam {
