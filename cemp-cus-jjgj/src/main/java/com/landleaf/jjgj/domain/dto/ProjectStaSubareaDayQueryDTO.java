...
/**
 * ProjectStaSubareaDayEntity对象的查询时的参数封装
 *
 * @author hebin
 * @since 2023-06-25
 */
...
@Schema(name = "ProjectStaSubareaDayQueryDTO对象", description = "ProjectStaSubareaDayEntity对象的查询时的参数封装")
public class ProjectStaSubareaDayQueryDTO extends PageParam {
