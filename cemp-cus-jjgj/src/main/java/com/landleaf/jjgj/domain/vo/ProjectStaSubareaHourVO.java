...
/**
 * ProjectStaSubareaHourEntity对象的展示信息封装
 *
 * @author hebin
 * @since 2023-06-25
 */
@Data
@Schema(name = "ProjectStaSubareaHourVO对象", description = "ProjectStaSubareaHourEntity对象的展示信息封装")
public class ProjectStaSubareaHourVO {
