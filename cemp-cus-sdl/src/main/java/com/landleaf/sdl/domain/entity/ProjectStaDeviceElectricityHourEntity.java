package com.landleaf.sdl.domain.entity;
...
@Schema(name = "ProjectStaDeviceElectricityHourEntity对象", description = "统计表-设备指标-电表-统计小时")
@TableName("tb_project_sta_device_electricity_hour")
public class ProjectStaDeviceElectricityHourEntity extends BaseEntity {
