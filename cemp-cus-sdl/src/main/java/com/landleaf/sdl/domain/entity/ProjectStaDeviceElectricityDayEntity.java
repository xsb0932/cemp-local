...
@Schema(name = "ProjectStaDeviceElectricityDayEntity对象", description = "统计表-设备指标-电表-统计天")
@TableName("tb_project_sta_device_electricity_day")
public class ProjectStaDeviceElectricityDayEntity extends BaseEntity {
